...
function floatchart() {
    ...
    // [ process-complience-chart ] start
    (function () {
        var options = {
            chart: {
                height: 200,
        ...
        var chart = new ApexCharts(document.querySelector("#process-complience-chart"), options);
        chart.render();
    })();
    ...
    (function () {
        ...
        var chart = new ApexCharts(document.querySelector("#user-chart2"), options);
        chart.render();
    })();
    // [ user-chart2 ] end
    // [ user-chart3 ] start
    (function () {
        ...
        var chart = new ApexCharts(document.querySelector("#user-chart3"), options);
        chart.render();
    })();
    // [ user-chart3 ] end
    // [ amunt-card1 ] start
    (function () {
        ...
        var chart = new ApexCharts(document.querySelector("#amunt-card1"), options);
        chart.render();
    })();
    // [ amunt-card1 ] end
    // [ amunt-card2 ] start
    (function () {
        ...
        var chart = new ApexCharts(document.querySelector("#amunt-card2"), options);
        chart.render();
    })();
    // [ amunt-card2 ] end
    // [ amunt-card3 ] start
    (function () {
        ...
        var chart = new ApexCharts(document.querySelector("#amunt-card3"), options);
        chart.render();
    })();
    // [ amunt-card3 ] end
    // [ amunt-card4 ] start
    (function () {
        ...
        var chart = new ApexCharts(document.querySelector("#amunt-card4"), options);
        chart.render();
    })();
    // [ amunt-card4 ] end
    ...
    (function () {
        ...
        var chart = new ApexCharts(
            document.querySelector("#feedback-chart"),
            options
        );
        chart.render()
    })();
    ...
    (function () {
        var options = {
            ...
            colors: ["#4099ff", "#0e9e4a", "#00bcd4", "#FFB64D", "#FF5370", "#7759de"],
